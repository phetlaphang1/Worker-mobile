...
interface SidebarProps {
  activeTab: "tasks" | "profiles" | "settings" | "twitter-caring" | "twitter-password" | "automation";
  onTabChange: (tab: "tasks" | "profiles" | "settings" | "twitter-caring" | "twitter-password" | "automation") => void;
  taskCount: number;
  runningTaskCount: number;
  profileCount: number;
  runningProfileCount: number;
  twitterCaringCount?: number;
  twitterPasswordCount?: number;
}
            ...
            <ul>
              <li>
                <button
                  ...
                  className={`w-full flex items-center px-3 py-2 text-sm font-medium rounded-md ${
                    activeTab === "profiles" || activeTab === "twitter-caring" || activeTab === "twitter-password"
                      ? "bg-primary text-white"
                      : "text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800"
                  } ${isCollapsed ? "justify-center" : ""}`}
              ...
              {(!isCollapsed && isProfilesExpanded) && (
                <>
                  ...
                  <li>
                    <button
                      onClick={() => onTabChange("twitter-password")}
                      className={`w-full flex items-center px-3 py-2 text-sm font-medium rounded-md ${
                        activeTab === "twitter-password"
                          ? "bg-primary/80 text-white"
                          : "text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800"
                      } ml-6`}
