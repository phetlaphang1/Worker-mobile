...
import { formatExecutionTimeAgo } from './profileUtils';
            ...
            >
              ...
              <TableCell className="text-right py-1">
                <ExecutionActions
                  ...
                  runTooltip="Run profile"
                  stopTooltip="Stop profile"
              ...
              <TableCell className="text-right py-1">
                <HandleColumn
                  ...
                  openBrowserTooltip="Open Chrome browser for testing with profile configuration"
                  duplicateTooltip="Duplicate profile with same configuration"
                  deleteTooltip="Delete profile and all associated data"
                />
              </TableCell>
            </TableRow>
          ))}
